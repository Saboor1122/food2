            ...
            <div className="bottom flex flex-col lg:flex-row justify-between mt-10 lg:px-20 md:px-10">
                <div className="about mb-5 lg:mb-0">
                    <ul className="list-none">
                        <li><Link to='/about' className='text-2xl font-bold hover:cursor-pointer hover:text-greenyellow'>About Us</Link></li>
                        <li><Link to='/privacy' className='text-xl hover:cursor-pointer hover:text-greenyellow'>Privacy Policy</Link></li>
                        <li><Link to='/feedback' className='text-xl hover:cursor-pointer hover:text-greenyellow'>Feedback</Link></li>
                    </ul>
                </div>
                <div className="contact mb-5 lg:mb-0">
                    <ul className="list-none">
                        <li><Link to="/contact" className='text-2xl font-bold hover:cursor-pointer hover:text-greenyellow'>Contact Us</Link></li>
                        <li><a href="https://www.google.com/maps/place/40%C2%B029'12.6%22N+3%C2%B021'01.3%22W/@40.4868355,-3.3529413,17z/data=!3m1!4b1!4m4!3m3!8m2!3d40.4868355!4d-3.3503664?entry=ttu"
                            className='text-xl hover:cursor-pointer hover:text-greenyellow'>Store Locator</a></li>
                        <li><Link to='/terms' className='text-xl hover:cursor-pointer hover:text-greenyellow'>Terms & Conditions</Link></li>
                    </ul>
                </div>
